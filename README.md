...
[![GitHub stars](https://img.shields.io/github/stars/data-scrape/tiktok-data-scraper-api?style=social)](https://github.com/data-scrape/tiktok-data-scraper-api)
[![GitHub forks](https://img.shields.io/github/forks/data-scrape/tiktok-data-scraper-api?style=social)](https://github.com/data-scrape/tiktok-data-scraper-api/fork)
[![GitHub issues](https://img.shields.io/github/issues/data-scrape/tiktok-data-scraper-api)](https://github.com/data-scrape/tiktok-data-scraper-api/issues)
[![GitHub license](https://img.shields.io/github/license/data-scrape/tiktok-data-scraper-api)](https://github.com/data-scrape/tiktok-data-scraper-api/blob/main/LICENSE)
[![Python](https://img.shields.io/badge/Python-3.8+-blue?logo=python)](https://www.python.org/)

</div>


> TikTok data scraper API - REST API for TikTok data extraction


<!-- SEO keywords: tiktok data scraper api, Tiktok Data Scraper Api, tiktok data scraper api python, tiktok data scraper api github -->
...
- RESTful API for TikTok data extraction
- Endpoints for videos, profiles, comments, hashtags
...
Build TikTok data services or influencer marketing tools.
...
```bash
pip install git+https://github.com/data-scrape/tiktok-data-scraper-api.git
```

### From source

```bash
git clone https://github.com/data-scrape/tiktok-data-scraper-api.git
cd tiktok-data-scraper-api
pip install -e .
```
...
```python
from tiktok_data_scraper_api import Scraper
...
```bash
python tiktok_data_scraper_api.py --query "your-query" --output results.json
```
...
### Is Tiktok Data Scraper Api legal to use?
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/data-scrape/tiktok-data-scraper-api)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/data-scrape/tiktok-data-scraper-api/issues)
